...
- 50d84a7: feat(code-quality): relax pedantic rules in test files and disable global `require-await`
...
- 3ead2ff: feat(code-quality): expand `base()` categories and add curated style rules
